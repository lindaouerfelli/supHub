...
import com.linda.suphub.Handlers.ExceptionRepresentation;
import com.linda.suphub.exceptions.ObjectValidationException;
import com.linda.suphub.exceptions.OperationNonPermittedException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionRepresentation> handleException(ObjectValidationException exception) {
        ExceptionRepresentation representation = ExceptionRepresentation.builder()
                .errorMsg("Object not valid exception has occurred")
